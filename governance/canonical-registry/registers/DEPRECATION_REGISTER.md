...
| DEP-0009 | Superseded | `SAOP.md` — GinzaAIpro Constitution v0.1 | [`Platform Constitution v1.0`](../../constitution/PLATFORM-CONSTITUTION.md) | Human constitutional authority reconciliation approved 2026-07-31 and recorded by DEC-0012. | SAOP.md remains preserved as historical constitutional source material; CON-0006 records the resolved authority conflict. |

No operative canonical rule was rejected. DEP-0009 records the explicit constitutional supersession of SAOP.md v0.1 while preserving its historical source and compatible incorporated principles.
