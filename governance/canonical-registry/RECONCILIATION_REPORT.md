...
59 registered rules, 20 decision entries, 9 deprecation/history entries,
26 terminology entries, 6 resolved conflicts, and 0 open conflicts.

## Classification summary

- **Active:** Platform Constitution v1.0; accepted CGS-0001, CGS-0004, and CGS-0005; accepted ADR-0001/0002, Capability 003 ADR-0003, and ADR-0007/0008/0009/0010/0011; accepted decisions DEC-0008/0009/0011 through DEC-0020; constitutional rules RULE-0028 through RULE-0037; governance-process rules RULE-0038 through RULE-0043; Capability 003 through 009 rules RULE-0044 through RULE-0059; accepted HCES-0000, HCES-0000A, HCES-0003, HCES-0004, HCES-0005, HCES-0006, HCES-0006A, HCES-0007, HCES-0007A, HCES-0008A, HCES-0008B, and HCES-0009; GM-0008B and GM-0009 as implementation authorization only; VVR-0003 through VVR-0009 as verification evidence only; canonical architecture rules; canonical specifications in their stated scopes; and compatible implementation-local contracts. Capabilities 003 through 009 remain verified but not released where no tracked accepted Release Record exists; Capabilities 004 and 005 also have no runtime engine.
...
The terminology register resolves or flags Event vs Operational Event, Event vs Signal, Runtime Health vs Operational Health, Operational Intelligence vs Operational Cognition, Observation vs Evidence vs OKG, Execution fields vs Execution Aggregate, orchestration naming, Organizational Dynamics, Operational Runtime, `OperationalCondition` as descriptive operational state, `OperationalLeakage` as governed consequence, `OperationalLeakagePriority` as governed relative importance, `OperationalRecommendation` as a governed intervention hypothesis, canonical planning-only `ExecutionPlan`, `RuntimeAdmission` as append-only runtime-entry authorization, and `ExecutionEvent` as one immutable occurrence fact distinct from execution control, workflow, evidence, outcomes, quality, AI, persistence, and publication, plus the relationship between the Governance Operating System authority layer and its Canonical Governance Standards.
